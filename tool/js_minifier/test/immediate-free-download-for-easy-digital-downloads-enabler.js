(function($){
    $( document ).ready( function() {
        ...
        if ( 'undefined' === typeof plugin_template_enabler ) {
            return true;
        }
        $.each( plugin_template_enabler, function( _iIndex, _aScrollbar ) {
            ...
            var _sElementClassName = 'plugin_template_' + String( _iIndex );
            ...
            $( _aScrollbar[ 'selector' ] ).mImmediateFreeDownloadForEDD( 
                _aOptions 
            );
